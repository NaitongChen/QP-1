...
\subsection{Proposal 1: Efficient cross validation via data subsampling} % enter your proposal title
...
% each mini-proposal gets its own subsection
\pagebreak
\subsection{Proposal 2: Using SURE to automate cross validation for principal component regression with L1 regularization} % enter your proposal title
