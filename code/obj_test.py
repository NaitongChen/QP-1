...
plt.legend()
plt.yscale("log")
path = os.path.normpath(os.path.join(os.path.dirname( __file__ ), "..", "plots", "collinear_tradeoff.png"))
plt.savefig(path)
plt.clf()

plt.plot(alphas, cv_scores_sure)
path = os.path.normpath(os.path.join(os.path.dirname( __file__ ), "..", "plots", "collinear_sure_obj.png"))
plt.savefig(path)
plt.clf()
...
path = os.path.normpath(os.path.join(os.path.dirname( __file__ ), "..", "plots", "collinear_5fold_obj.png"))
plt.savefig(path)
plt.clf()
...
path = os.path.normpath(os.path.join(os.path.dirname( __file__ ), "..", "plots", "collinear_10fold_obj.png"))
plt.savefig(path)
plt.clf()
...
path = os.path.normpath(os.path.join(os.path.dirname( __file__ ), "..", "plots", "collinear_loocv_obj.png"))
plt.savefig(path)
plt.clf()